<template>
  <span
    class="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium rounded-full border transition-all duration-200 hover:scale-105"
...
const props = defineProps<{
  icon?: string;
  variant?: "default" | "accent" | "violet" | "emerald" | "amber" | "sky";
}>();
...
const variantClasses = computed(() => variantMap[props.variant || "default"]);
</script>
